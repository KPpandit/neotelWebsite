...
const PaymentGateway = ({ selectedPlan, disabled }) => {
  ...
  const handlePayment = async () => {
    ...
    const Number = localStorage.getItem('Number') || sessionStorage.getItem('Number');
    ...
    const paymentData = {
      ...
      successUrl: "https://payment.neotel.nr/callbackstatus?status=success&transactionId=_transactionId_&amount=_amount_&quantity=_quantity_&name=_name_&msisdn=_msisdn_",
      failureUrl: "https://payment.neotel.nr/callbackstatus?status=failure&transactionId=_transactionId_&amount=_amount_&quantity=_quantity_&name=_name_&msisdn=_msisdn_"
    };
